    ...
    <div>
      ...
      <div className="border rounded p-4 flex flex-col gap-4">
          ...
          <div className="grid grid-cols-6 gap-4">
            {existingImgUrls.map((url) => (
              <div className="relative group">
                <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 text-white">
        ...
        <input
          ...
          {...register("imageFiles", {
            validate: (imageFiles) => {
              const length = imageFiles.length + (existingImgUrls?.length || 0);
